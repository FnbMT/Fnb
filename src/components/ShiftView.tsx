         ...
         <div className="bg-white dark:bg-[#1a1b1e] border border-black/10 dark:border-white/10 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
             <div className="flex items-center gap-4">
                 <div className={cn("w-12 h-12 rounded-full flex items-center justify-center shrink-0", 
                    ...
                    attendanceStatus === 'checked_out' ? "bg-emerald-500/20 text-emerald-600" :
                 ...
                 <div>
                     ...
                     <p className={cn("text-sm font-bold mt-0.5", 
                        ...
                        attendanceStatus === 'checked_out' ? "text-emerald-600 dark:text-emerald-400" :
                        "text-rose-600 dark:text-rose-400")}>
                         {attendanceStatus === 'checked_in' ? "Hôm nay bạn đã chấm công thành công (Đang trong ca)" : 
                          attendanceStatus === 'checked_out' ? "Đã kết thúc ca làm việc (Sẵn sàng ca mới)" :
             ...
             >
                 ...
                 {attendanceStatus === 'checked_in' 
                   ...
                   : (attendanceStatus === 'checked_out' ? "Quét mã QR Chấm công (Ca mới)" : "Quét mã QR Chấm công")}
             </button>
         </div>
      )}
