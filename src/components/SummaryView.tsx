      ...
      <div className="flex flex-col md:flex-row gap-4 items-center bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 p-4 rounded-2xl">
        ...
        <div className="relative flex-1">
          ...
          <input 
            ...
            className="w-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-xl py-2 pl-10 pr-4 text-gray-900 dark:text-white focus:outline-none focus:border-emerald-500/50"
